...
import { PiSpeakerHigh, PiSun, PiMoon, PiWaveform, PiGraduationCap } from 'react-icons/pi';
...
const actionItems = [
  ...
  {
    id: 'action.about',
    labelKey: _('About Palimpsest'),
    keywords: ['about', 'palimpsest', 'version', 'info'],
  },
];
