...
interface TTSFollowIndicatorProps {
  ...
  /**
   * Non-Edge sentence-level following is paced by an estimator, not exact
   ...
   * gray-500 overlay + currentColor text for full-screen immersive overlays that
   * paint their own theme surface, where daisyui base tokens would clash with
   * the book theme.
   */
  variant?: 'base' | 'plain';
  className?: string;
