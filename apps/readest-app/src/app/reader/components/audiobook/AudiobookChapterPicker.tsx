...
const AudiobookChapterPicker = ({
  ...
  return (
    <div className='eink-bordered border-ink/20 bg-paper mt-3 overflow-hidden rounded-[2px] border'>
      <div className='border-ink/15 flex items-center gap-2 border-b p-2'>
        <input
          type='search'
        ...
        <button
          type='button'
          className='chrome-ghost chrome-ghost-sm'
      ...
      <div
        className='divide-ink/10 max-h-64 overflow-y-auto divide-y'
        role='listbox'
      ...
      >
        <button
          ...
          role='option'
          aria-selected={!value}
          className='hover:bg-paperlight flex min-h-11 w-full items-center gap-3 px-3 py-2 text-start'
          onClick={() => onSelect('')}
        >
          ...
          return (
            <div key={chapter.id} className='flex min-h-12 items-center gap-1 pe-2'>
              <button
                ...
                className='hover:bg-paperlight flex min-w-0 flex-1 items-center gap-3 px-3 py-2 text-start'
        ...
        {filtered.length === 0 && (
          <p className='text-paperlight px-3 py-5 text-center text-sm'>
