 ...
 * format requirements, usage hints, etc. Subtle `bg-paperlight/40` surface,
...
const Tips: React.FC<TipsProps> = ({ title, children, className }) => {
  ...
  return (
    <div className={clsx('bg-paperlight/40 rounded-[2px] p-3', className)}>
      ...
      <div className='text-ink/70 text-[0.85em]'>
            ...
            return (
              <li key={i} className='flex items-start gap-2'>
                <span className='flex h-[1.4em] w-4 flex-shrink-0 items-center justify-center'>
                  <span className='bg-ink/70 h-1.5 w-1.5 rounded-full' />
                </span>
